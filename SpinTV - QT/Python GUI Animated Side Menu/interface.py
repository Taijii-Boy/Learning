...
"}")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 198, 517))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 200, 517))
        ...
        self.label_6.setStyleSheet("border: 5px solid rgb(230,5,64);\n"
"border-radius: 30px;")
        self.label_6.setText("")
        self.label_6.setPixmap(QtGui.QPixmap(":/icons/icons/github.svg"))
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_11.addWidget(self.label_6, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignBottom)
        ...
        self.verticalLayout.addWidget(self.main_body_contents, 0, QtCore.Qt.AlignHCenter)
        ...
        self.size_qrip = QtWidgets.QFrame(self.footer)
        self.size_qrip.setMinimumSize(QtCore.QSize(10, 10))
        self.size_qrip.setMaximumSize(QtCore.QSize(10, 10))
        self.size_qrip.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.size_qrip.setFrameShadow(QtWidgets.QFrame.Raised)
        self.size_qrip.setObjectName("size_qrip")
        self.horizontalLayout_3.addWidget(self.size_qrip, 0, QtCore.Qt.AlignRight|QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Some text you would like to fill here"))
        ...
        self.label.setText(_translate("MainWindow", "ModernUI v. 7.7.7"))
import icons_rc
